...
public class Networkbuilder {
    ...
    private final CodeBlock.Builder writerPre = CodeBlock.builder();
    private final CodeBlock.Builder writerPre2 = CodeBlock.builder();
    private final CodeBlock.Builder writer = CodeBlock.builder();
    private final CodeBlock.Builder writerPost = CodeBlock.builder();
    private final CodeBlock.Builder readerPre = CodeBlock.builder();
    private final CodeBlock.Builder reader = CodeBlock.builder();
    private final CodeBlock.Builder readerPost = CodeBlock.builder();

    private final MethodSpec.Builder writerBuilder;
    private final MethodSpec.Builder readerBuilder;
    ...
    CodeBlock buildWriter() {
        return CodeBlock.builder().add(writerPre.build()).add(writerPre2.build()).add(writer.build())
                .add(writerPost.build()).build();
    }
    ...
    Networkbuilder beginNullable(ParameterSpec parameter) throws TooManyNullableParametersException {
        ...
        isInNuller = CodeBlock.builder()
                .add("(($L & 0b$L) != 0) ? null : ", NULLER, Integer.toBinaryString(nextNullerBit)).build();
